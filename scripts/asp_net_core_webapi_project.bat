...
set "titleproj=Asp Net Core WebApi Project"
set "pthdotnet=C:\\Program Files\\dotnet\\sdk"
set "dirproj=C:\\Users\\%username%\\Documents\\Visual Studio 2019\\Projects\\ProjectGenerator\\dist\\AspNetCoreWebApi"
...
dotnet new webapi -o "%dirproj%" --no-https
...
if /I "%isrunproj%"=="true" (
    cls
    start "chrome" "http://localhost:5000/swagger"
