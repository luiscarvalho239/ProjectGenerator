...
set "titleproj=Asp Net Core Angular Project"
set "pthdotnet=C:\\Program Files\\dotnet\\sdk"
set "dirproj=C:\\Users\\%username%\\Documents\\Visual Studio 2019\\Projects\\ProjectGenerator\\dist\\AspNetCoreAngularApp"
...
dotnet new angular -o "%dirproj%" --no-https
