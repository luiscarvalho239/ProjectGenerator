...
set "titleproj=Blazor Server Project"
set "pthdotnet=C:\\Program Files\\dotnet\\sdk"
set "dirproj=C:\\Users\\%username%\\Documents\\Visual Studio 2019\\Projects\\ProjectGenerator\\dist\\BlazorApp"
...
dotnet new blazorserver -o "%dirproj%" --no-https
