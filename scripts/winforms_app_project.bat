...
set "titleproj=Winforms Application Project"
set "pthdotnet=C:\\Program Files\\dotnet\\sdk"
set "dirproj=C:\\Users\\%username%\\Documents\\Visual Studio 2019\\Projects\\ProjectGenerator\\dist\\WinformsApp"
