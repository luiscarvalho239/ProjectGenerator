...
set "titleproj=Blazor Web Assembly Project"
set "pthdotnet=C:\\Program Files\\dotnet\\sdk"
set "dirproj=C:\\Users\\%username%\\Documents\\Visual Studio 2019\\Projects\\ProjectGenerator\\dist\\BlazorWASMApp"
...
dotnet new blazorwasm -o "%dirproj%" --no-https
