...
set "titleproj=Asp Net Core WebApp Project"
set "pthdotnet=C:\\Program Files\\dotnet\\sdk"
set "dirproj=C:\\Users\\%username%\\Documents\\Visual Studio 2019\\Projects\\ProjectGenerator\\dist\\AspNetCoreWebApp"
...
dotnet new webapp -o "%dirproj%" --no-https
